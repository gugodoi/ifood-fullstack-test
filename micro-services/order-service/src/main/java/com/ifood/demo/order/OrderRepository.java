...
public interface OrderRepository extends CrudRepository<Order, UUID> {
	...
	@RestResource(path = "byClientIdsAndDate")
	Collection<Order> findByClientIdInAndCreatedAtBetween(@Param("clientIds") List<UUID> clientId, @Param("start") Date start, @Param("end") Date end);
}